...
/**
 * @typedef {(token: string, remotePublicKey: Uint8Array) => AuthZResponse | Promise<AuthZResponse>} OnAuthz
 * @typedef {(remotePublicKey: Uint8Array) => MagicLinkResponse | Promise<MagicLinkResponse>} OnMagicLink
